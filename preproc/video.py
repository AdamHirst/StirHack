...
class FaceDetector:
	...
	# returns true, along with the image in question, a list of x,y,w,h
	# tuples, and the timestamp that the image was taken on if the main camera
	# detects a face - if the main camera fails to grab a frame or does not
	# detect a face then false is returned
	def hasFace(self):
